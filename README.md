...
A Redis clone implementation in C++, built as part of the CodeCrafters "Build Your Own Redis" challenge. This project implements core Redis functionality, including data structures, persistence, replication, pub/sub messaging, and authentication.
